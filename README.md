...
4. Then we finally got technique that gives <ins> live data of movies </ins> from every corner of india , the code for is written in [<ins> helper_funtions.py </ins>](https://github.com/omk003/movieAgent/blob/main/helper_funtions.py) and I think we were the only one who got the live data this way. With one click we can get live data of current available seat for movies
